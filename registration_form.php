    ...
    <div class="row">
      <div class="col-md-6">
        <div class="form-group">
          ...
          <div class="col-md-12">
            <input type='text' id="nombre" name="nombre" placeholder="Nombre"  maxlength="20" value="<?php echo $nombre ?>" />
          </div>
        </div>
        <div class="form-group">
          <span class="col-md-1 col-md-offset-2 text-center"><i class="fa fa-user bigicon"></i></span>
        ...
        <div class="form-group">
          ...
          <div class="col-md-12">
            ...
            <input type='text' id="usuario" placeholder="usuario" name="usuario" maxlength="15" value="<?php echo $usuario ?>" />
          </div>
        </div>
      </div>
      <div class="col-md-6">
        <div class="form-group">
          ...
          <div class="col-md-12">
            ...
            <input type='password' id="password" name="password" placeholder="Password" maxlength="20" value="<?php echo $password ?>" />
        ...
        <div class="form-group">
          <span class="col-md-1 col-md-offset-2 text-center"><i class="fa fa-key bigicon"></i></span>
          <div class="col-md-12">
            <input type='password' id="password2" name="password2"  placeholder="Repite tu Password" maxlength="20" value="<?php echo $password2 ?>" onmouseout="igualPass()" required/>
          </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <div class="radio">
            <label for="radios-0">
              <input type="radio" name="idrol" id="radios-0" value="1" checked="checked">
              Reservar
            </label>
        	</div>
          <div class="radio">
            <label for="radios-1">
              <input type="radio" name="idrol" id="radios-1" value="2">
              Subir Alojamientos
            </label>
        	</div>
          </div>
