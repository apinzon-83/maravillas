...
<head>
<title>Maravillas del Eden</title>
<meta charset="utf-8">
            ...
            <li class="sub-menu sub-menu-1"><a href="#">Páginas<em></em></a>
              <ul>
                <li><a href="flights.html">Vuelos</a>
                  <ul>
                    <li><a href="search-flights.html">Búsqueda de Vuelos</a></li>
                    <li><a href="booking-flights.html">Booking Vuelos</a></li>
                    <li><a href="booking-flights-page.html">Vuelos Checkout</a></li>
                  </ul>
                </li>


                <li><a href="hotels.html">Hoteles</a>
                  <ul>
                    <li><a href="search-hotel.html">Búsqueda de Hoteles</a></li>
                    <li><a href="booking-hotel.html">Booking Hotel</a></li>
                    <li><a href="booking-hotel-page.html">Hotel Reservación</a></li>
                  </ul>
                </li>

                <li><a href="cars.html">Renta de Carros</a>
                  <ul>
                    <li><a href="search-cars.html">Búsqueda de Carros</a></li>
                    <li><a href="booking-cars.html">Booking Car</a></li>
                    <li><a href="booking-cars-page.html">Reservación de Carros</a></li>
                  </ul>
                </li>
                <li><a href="cruises.html">Cruceros</a>
                  <ul>
                    <li><a href="search-cruise.html">Búsqueda de Cruceros</a></li>
                    <li><a href="booking-cruise.html">Booking Cruceros</a></li>
                    <li><a href="booking-cruise-page.html">Cruceros Checkout</a></li>
                  </ul>
                </li>
              </ul>
            </li>
      ...
      <div class="tabs tabs1">
        <div class="tabs_tabs tabs1_tabs">
            ...
            <ul>
              ...
              <li class="cars"><a href="#tabs-3">Carros</a></li>
              <li class="cruises"><a href="#tabs-4">Cruceros</a></li>
            </ul>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-4 col-md-2">
                    <div class="select1_wrapper">
                      ...
                      <div class="select1_inner">
                        <select class="select2 select" style="width: 100%">
                          <option value="1">Habitación para  1  adulto</option>
                          <option value="2">Habitación para  2  adultos</option>
                          <option value="3">Habitación para  3  adultos</option>
                          <option value="4">Habitación para  4  adultos</option>
                          <option value="5">Habitación para  5  adultos</option>
                          <option value="6">Habitación para  6  adultos</option>
                          <option value="7">Habitación para  7  adultos</option>
                          <option value="8">Habitación para  8  adultos</option>
                        </select>
                      </div>
                    </div>
                  </div>
                ...
                <div class="row">
                  <div class="col-sm-4 col-md-2">
                    <div class="select1_wrapper">
                      ...
                      <div class="select1_inner">
                        <select class="select2 select" style="width: 100%">
                          <option value="1">porfavor Seleccione</option>
                          <option value="2">Alaska</option>
                          <option value="3">Bahamas</option>
                          <option value="4">Bermuda</option>
                          <option value="5">Canada</option>
                  ...
                  <div class="col-sm-4 col-md-2">
                    <div class="select1_wrapper">
                      ...
                      <div class="select1_inner">
                        <select class="select2 select" style="width: 100%">
                          <option value="1">Pofavor Seleccione</option>
                          <option value="2">Alaska</option>
                          <option value="3">Bahamas</option>
                          <option value="4">Bermuda</option>
                          <option value="5">Canada</option>
...
<div id="why1">
  <div class="container">
    ...
    <h2 class="animated">porque SOMOS LOS MEJORES</h2>

    <div class="title1 animated" style="text-align:justify;">
      Nos distinguimos por querer brindar todos los servicios que nuestros clientes necesiten a la hora de vacacionar,
escuchar sus necesidades, encontrar la solución a ellas es nuestro motor que nos impulsa a seguir innovando y mejorando nuestros servicios.
    </div>
        ...
        <div class="thumb2 animated" data-animation="flipInY" data-animation-delay="200">
          <div class="thumbnail clearfix">
            <a >
              ...
              <div class="caption">
                <div class="txt1">Asombrosos viajes</div>
                <div class="txt2">
                  ¿Qué te frena a cumplir tus sueños de viajar por el mundo?
                  Disfruta y conoce todo lo que el mundo te ofrece gracias a nuestras diversas opciones para tu viaje.
                </div>
          ...
          <div class="thumbnail clearfix">
            <a >
              ...
              <div class="caption">
                ...
                <div class="txt2">
                  Descubre las maravillas del mundo, conoce nuestros distintos
                  servicios y elige el que más se adapte a tus necesidades.
                </div>
        ...
        <div class="thumb2 animated" data-animation="flipInY" data-animation-delay="400">
          <div class="thumbnail clearfix">
            <a >
              ...
              <div class="caption">
                <div class="txt1">Reserve su Viaje</div>
                <div class="txt2">
                  Reserva en nuestros distintos hoteles, casas, clubs vacacionales y
          ...
          <div class="thumbnail clearfix">
            <a >
              ...
              <div class="caption">
                ...
                <div class="txt2">
                  Nuestro equipo de expertos estarán a su disposición para cualquier duda a la hora de tu reserva.
                </div>
